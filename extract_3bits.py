...
len_data0, encrypted_msg1 = extract_data(pixels,ROWS,COLUMNS,row=200,column=30,bit_pos=2,RGB='G')
#len_data1, encrypted_msg1 = extract_data(pixels,ROWS,COLUMNS,bit_pos=1,RGB='G')
#len_data2, encrypted_msg2 = extract_data(pixels,ROWS,COLUMNS,bit_pos=2,RGB='G')
...
decrypted_data0 = des3_decryption(KEY_s, encrypted_msg0)
'''
decrypted_data1 = des3_decryption(KEY_s, encrypted_msg1)
decrypted_data2 = des3_decryption(KEY_s, encrypted_msg2)
#### decrypt data after extraction ####
print 'Original Message is: %s' % (decrypted_data0+decrypted_data1+decrypted_data2)
'''
print 'Original msg is: %s' % (decrypted_data0)
#### Extracting data from the image ####
