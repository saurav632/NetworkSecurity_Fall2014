...
embed_data(pixels, data_byted,ROWS,COLUMNS,row=200,column=30,bit_pos=2,RGB='G')
'''
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=1,RGB='G')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=2,RGB='G')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=3,RGB='G')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=4,RGB='G')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=5,RGB='G')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=0,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=1,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=2,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=3,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=4,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=5,RGB='R')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=0,RGB='B')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=1,RGB='B')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=2,RGB='B')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=3,RGB='B')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=4,RGB='B')
embed_data(pixels, data_byted,ROWS,COLUMNS,bit_pos=5,RGB='B')
'''
#### So, first the length of the message is embedded, then the message ####
